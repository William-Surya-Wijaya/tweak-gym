...
function sendVerificationEmail(toEmail, token) {
  ...
  const mailOptions = {
    ...
    <div style="font-family: Arial, sans-serif; background-color: #f2f2f2; padding: 20px; text-align: center;">
      ...
      <a href="https://d5cc-2405-8180-803-fb88-1422-47cb-d70c-3e4a.ngrok-free.app/verify?token=${token}" style="display: inline-block; padding: 10px 20px; background-color: #007BFF; color: #fff; text-decoration: none; font-size: 16px; border-radius: 5px;">Verifikasi Email</a>
